...
double direct_conv(double probs[], int probslen, double result[]){
...
void splitter(double p_vec[], int *p_vec_len, int *num_splits, double result_vec[]){
  ...
  for (i = 0; i < leftover; i++){
    ...
    for (i = 0; i < number_splits; i++){
        direct_conv(p_vec+memory_index_tracker, num_in_each[i], result_vec+memory_index_tracker+i);
